...
#Step5 : Looping through files
# Looping through files allows you to read and process data from files line by line.
# This is useful for reading game data, configuration files, or logs.
#example 1: Reading a file line by line.
print("Reading a file line by line:")
try:
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        for line in file:  # Loop through each line in the file.
            print(line.strip())  # Print each line, removing leading/trailing whitespace.
except FileNotFoundError:
    print("File not found. Please check the file path.")

#example 2: Reading a file and processing each line.
print("Processing each line in a file:")
try:
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        for line in file:  # Loop through each line in the file.
            data = line.strip().split(",")  # Split the line into a list using commas as separators.
            print(f"Processing data: {data}")  # Print the processed data.
except FileNotFoundError:
    print("File not found. Please check the file path.")
...
try:
    with open("output_data.txt", "w") as file:  # Open the file in write mode.
        for i in range(1, 6):  # Loop through numbers from 1 to 5.
            file.write(f"Line {i}: This is some output data.\n")  # Write each line to the file.
    print("Data written to output_data.txt successfully.")
except IOError:
    print("An error occurred while writing to the file. Please check the file path and permissions.")
#example 4: Appending data to a file using a loop.
print("Appending data to a file:")
try:
    with open("output_data.txt", "a") as file:  # Open the file in append mode.
        for i in range(6, 11):  # Loop through numbers from 6 to 10.
            file.write(f"Line {i}: This is additional output data.\n")  # Append each line to the file.
    print("Data appended to output_data.txt successfully.")
except IOError:
    print("An error occurred while appending to the file. Please check the file path and permissions.")

#example 5: Reading a file and counting lines.
print("Counting lines in a file:")
try:
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        line_count = sum(1 for line in file)  # Count the number of lines in the file using a generator expression.
    print(f"The file contains {line_count} lines.")
except FileNotFoundError:
    print("File not found. Please check the file path.")
# Note: Looping through files is a common practice in game development for reading and writing game data.
# Always handle file operations with care, ensuring proper error handling and resource management.
#example 6: Reading a file and searching for a specific keyword.
print("Searching for a keyword in a file:")
try:
    keyword = "hero"  # Keyword to search for in the file.
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        found = False  # Flag to indicate if the keyword was found.
        for line in file:  # Loop through each line in the file.
            if keyword in line:  # Check if the keyword is present in the line.
                print(f"Found '{keyword}' in line: {line.strip()}")  # Print the line containing the keyword.
                found = True  # Set the flag to True if the keyword is found.
        if not found:
            print(f"'{keyword}' not found in the file.")  # Print a message if the keyword was not found.
except FileNotFoundError:
    print("File not found. Please check the file path.")
# Note: When working with files, always ensure that the file exists and handle exceptions appropriately.
#example 7: Reading a file and counting occurrences of a specific word.
print("Counting occurrences of a specific word in a file:")
try:
    word_to_count = "hero"  # Word to count occurrences of in the file.
    count = 0  # Initialize a counter for occurrences.
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        for line in file:  # Loop through each line in the file.
            count += line.lower().count(word_to_count.lower())  # Count occurrences of the word in the line, ignoring case.
    print(f"The word '{word_to_count}' occurs {count} times in the file.")
except FileNotFoundError:
    print("File not found. Please check the file path.")
# Note: Looping through files is a powerful way to read and process data in game development.
# Always ensure proper file handling and error management to avoid issues during file operations.
#example 8: Reading a file and extracting specific data.
print("Extracting specific data from a file:")
try:
    with open("game_data.txt", "r") as file:  # Open the file in read mode.
        for line in file:  # Loop through each line in the file.
            if "hero" in line:  # Check if the line contains the keyword "hero".
                data = line.strip().split(",")  # Split the line into a list using commas as separators.
                print(f"Extracted data: {data}")  # Print the extracted data.
except FileNotFoundError:
    print("File not found. Please check the file path.")
# Note: Looping through files is essential for reading and processing game data, configuration files, or logs.
# Always handle file operations with care, ensuring proper error handling and resource management.
